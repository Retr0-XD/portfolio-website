// src/components/hero.rs — Sakthi Harish Portfolio × Leptos 0.7
//
// ── UI COMPONENT ─────────────────────────────────────────────────────────────
    ...
    view! {
        <section class="hero-section grid grid-cols-1 md:grid-cols-12 border-b">
            ...
            <div class="col-span-full md:col-span-7 p-[clamp(32px,5vw,80px)] flex flex-col justify-center border-r">
                <h1 class="hero-title font-serif text-[clamp(3rem,8vw,7.5rem)] font-black leading-[0.95] tracking-[0.04em]">
