// src/components/header.rs — Sakthi Harish Portfolio × Leptos 0.7
//
// ── UI COMPONENT ─────────────────────────────────────────────────────────────
    ...
    view! {
        <header class="ed-header sticky top-0 z-100 bg-bg grid grid-cols-2 md:grid-cols-12">
            ...
            <div class="col-span-1 md:col-span-6 p-[clamp(16px,2.5vw,32px)] flex justify-center items-center border-r border-b">
                <span class="logo font-serif text-[clamp(0.8rem,1.2vw,1rem)] font-bold tracking-[0.15em] hover-target">"SAKTHI HARISH"</span>
            </div>
